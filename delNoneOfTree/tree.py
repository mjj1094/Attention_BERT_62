...
from delNoneOfTree.utility import quantize, aset, symbol, desymbol, is_conj, is_punc, is_func

from delNoneOfTree import heads
...
class Tree(object):
    ...
    def annotate(self, max_outs, parentlabel=None, do_sub=True, dep=0):
        ...
        if self.is_terminal():
            ...
            for htype in htypes:
                ...
                if print_heads:
                    print
                    " |  " * dep, self.spanlabel(), " ", self.get_lexhead(htype)
    ...
    def _parse(line, pos=0, wrdidx=0, trunc=True, lower=False):
        ...
        if line[newpos] == '(':
            ...
            return (finalpos + 1, wrdidx + 1 if not empty else wrdidx), empty, Tree(label, (wrdidx, wrdidx + 1),
                                                                                    wrd=word)
...
if __name__ == "__main__":
    ...
    #     if len(t) <= max_len:
    #         print(t)
    # line="(TOP (IP-HLN (NP-PN-SBJ (NR 波黑)) (VP (VV 达成) (NP-OBJ (NP-PN (NR 戈拉日代)) (NP (NN 停火) (NN 协议))))))"
    line="(TOP (IP (IP (NP-SBJ (DNP (NP-PN (NR 宋楚瑜)) (DEG 的)) (NP (NN 解释))) (VP (VP (ADVP (AD 并)) (ADVP (AD 未)) (VP (VV 使) (NP-OBJ (NN 舆论))(IP (NP-SBJ (-NONE- [MASK])) (VP (VV 平息))))) (PU ，) (VP (ADVP (AD 反而)) (VP (VV 引起) (NP-OBJ (ADJP (ADVP (AD 更)) (ADJP (JJ 多))) (NP (NN 臆测))))))) (PU ，) (IP (ADVP (AD 于是)) (NP-SBJ (PN 他)) (VP (PP-TMP (P 在) (NP (NT 十二月) (NT 十四日))) (VP (VP (VV 召开) (NP-OBJ (NN 记者会))) (VP (VV 说明) (PU ，) (IP-OBJ (NP-SBJ (DNP (NP-PN (NR 宋镇远)) (DEG 的)) (NP (NN 资金))) (VP (VC 是) (IP-PRD (NP-SBJ (-NONE- [MASK])) (VP (PP-LOC (P 在) (LCP (NP (NP (NP-APP (NP-PN (NR 国民党)) (NP (NN 主席))) (NP-PN (NR 李登辉))) (NP (NN 指示))) (LC 下))) (PU ，) (VP (BA 将) (IP-OBJ (NP-SBJ (CP (WHNP-2 (-NONE- [MASK])) (CP (IP (NP-SBJ (-NONE- [MASK])) (VP (ADVP (AD 原)) (VP (PP-PRD (P 在) (NP (NP (NP-PN (NR 国民党)) (NP (NN 秘书长))) (NP (NN 专户))))))) (DEC  的))) (NP (NN 款项))) (PU ，) (VP (VP (PP-LGS (P 经由) (NP (NP (ADJP (JJ 党营)) (NP-PN (NR 华夏) (NN 投资) (NN 公司))) (CC 与) (NP (NP-PN (NR 国民党)) (NP (NN 中央) (NN 委员会))))) (PU ，) (VP (VV 拨交) (QP-OBJ (CD 一亿四千六百四十六万余) (CLP (M 元))))) (PU ，) (VP (ADVP (AD 分别)) (VP (VP (VV 借用) (NP-OBJ (DNP (NP-PN (NR 宋镇远) (CC 与) (NR 陈碧云)) (DEG 之)) (NP (NN 帐户)))) (VP (VV 存放)))) (PU ，) (VP (VV 委由) (NP-PN-OBJ (NR 宋楚瑜)) (IP (NP-SBJ (-NONE- [MASK])) (VP (VV 执行) (NP-OBJ (UCP-APP (IP (NP-SBJ (-NONE- [MASK])) (VP (VV 照顾) (NP-OBJ (NP (NP-APP (ADJP (JJ 前)) (NP (NN 主席))) (NP-PN (NR 蒋经国))) (NP (NN 家族) (NN 后代))))) (PU ，) (CC 及) (NP (CP (WHNP-1 (-NONE- [MASK])) (CP (IP (NP-SBJ (NN 主席)) (VP (ADVP (AD 特别)) (VP (VV 指示)  (NP-OBJ (-NONE- [MASK]))))) (DEC 之))) (NP (NN 党) (NN 政)) (NP (NN 工作))) (ETC 等)) (NP (NN 任务))))))))))))))))) (PU 。)))"
    t = Tree.parse(line.strip(), lower=False)
    print(line)
    print(t)